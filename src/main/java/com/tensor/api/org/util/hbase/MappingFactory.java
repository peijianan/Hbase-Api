    ...
    private static class Mapper {
        ...
        void init(Class cls) {
            ...
            for (Field field : fields) {
                if (field.isAnnotationPresent(com.tensor.api.org.annotation.Field.class)) {
                    com.tensor.api.org.annotation.Field f = field.getAnnotation(com.tensor.api.org.annotation.Field.class);
